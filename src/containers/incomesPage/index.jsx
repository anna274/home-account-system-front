...
import { deleteIncome, getIncomes, getCategories, getBankAccounts, showModal, getExpenses } from 'redux/actions';
...
const IncomesPage = () => {
  ...
  return (
    <div className={classes.page}>
      ...
      <Table columns={incomeExpenseColumns} rows={incomes} deleteHandler={deleteHandler} editHandler={editHandler} classes={pageClasses}/>
      <Button
        variant="contained"
        color="primary"
