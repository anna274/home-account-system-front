import { getCategoriesInfo, createCategoryInfo, editCategoryInfo, deleteCategoryInfo } from 'services'
...
const getCategories = (categoryType) => {
  return async (dispatch) => {
    try{
      ...
      const categories = await getCategoriesInfo(categoryType.toLowerCase());
      dispatch({
